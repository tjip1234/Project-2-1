...
public class PlayerCardHandler {
    ...
    public PlayerCardHandler(Playfield playfield, float angle, int playerNumber) {
        ...
        for (int i = 0; i < 3; ++i) {
            ...
            cardPositions[i] = new Vector2(positionRelativeToOrigin.x() + thisOrigin.x(),
                    positionRelativeToOrigin.y() + thisOrigin.y());
    ...
    public void addNewCard() {
        ...
        hand.forEach(c -> {
            ...
            drawable.flipToBack(playerNumber, distanceFromCentre);
            drawable.setCard(c);
