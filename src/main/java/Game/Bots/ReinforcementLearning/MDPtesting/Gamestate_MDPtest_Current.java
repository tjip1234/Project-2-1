...
public class Gamestate_MDPtest_Current implements Serializable , Gamestate{
    public int[] table;
    public int[] hand;
    public int[] deck;
    public int briscola;

    public Gamestate_MDPtest_Current() {
    ...
    public Gamestate clone() {
        Gamestate k = new Gamestate_MDPtest_Current();
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof Gamestate_MDPtest_Current otherGS)) {
            return false;
        }
